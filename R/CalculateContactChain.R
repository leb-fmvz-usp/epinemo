...
#' It calculates the contact chain.
#' @description Function to calculate outgoing and ingoing contact chains.
...
#' @details This is a function that calculates the contact chain of a dynamic network.
#' @return \code{\link{data.frame}}. The first column \code{$id} is the original ID of each node, \code{$ingoing}, is the ingoing contact chain value and \code{$outgoing}, is the outgoing contact chain value.
#' @references 
